...
, ...
  ...
  users.users.leviticusc = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEDlQL1/GlsK2kmUY8/UZu5C+quiQsu68yaYbt3eLk9j nixer@elliotpc"
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEL04vd66T55rh8PmSXl3OgdBYA61/OiEbWGq7+JVSuO nixer@minmus"
    ];
  };
  users = {
